...
function playRawFile (word) {
  const dir = getConfig('rawDirectory')
  const rawFile = path.join(getConfig('rawDirectory'), getRawFileForWord(word))
  ...
  activate () {
    ...
    this.disposable = new CompositeDisposable(
      atom.commands.add('atom-text-editor:not([mini])', {
        ...
        'vocabuilder:toggle-use-play-raw' () {
          toggleConfig('usePlayRaw')
        },
